// src/modules/gestion_bodega/components/tablero/ResumenInventarios.tsx
...
const ResumenInventarios: React.FC<Props> = ({ rows, meta, loading, onPageChange }) => {
  return (
...
export default ResumenInventarios;
