...
const CategoriaAutocomplete: React.FC<Props> = ({
  ...
  const options: Option[] = useMemo(() => [newOption, ...categorias], [categorias]);
    ...
    <Box>
      <Autocomplete
        ...
        isOptionEqualToValue={(o, v) => {
          if (o.id === 'new' && v.id === 'new') return true;
          return o.id !== 'new' && v.id !== 'new' && o.id === v.id;
        }}
