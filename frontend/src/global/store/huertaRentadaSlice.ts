...
export const createHuertaRentada = createAsyncThunk<HuertaRentada, HuertaRentadaCreateData, { rejectValue: unknown }>(
...
export const deleteHuertaRentada = createAsyncThunk<number, number, { rejectValue: unknown }>(
