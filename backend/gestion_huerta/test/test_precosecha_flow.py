...
class PreCosechaReportingAndDashboardTests(TestCase):
    ...
    def test_reporte_temporada_incluye_bloque_separado_de_precosecha(self):
        ...
        self.assertEqual(reporte["resumen_ejecutivo"]["ganancia_operativa_acumulada"], 0.0)
        self.assertEqual(reporte["resumen_ejecutivo"]["recuperado_precosecha"], 0.0)
        self.assertEqual(reporte["resumen_ejecutivo"]["pendiente_precosecha"], 120.0)
        self.assertEqual(reporte["resumen_ejecutivo"]["porcentaje_recuperado_precosecha"], 0.0)
        self.assertEqual(reporte["resumen_ejecutivo"]["excedente_post_precosecha"], 0.0)
        self.assertEqual(reporte["resumen_ejecutivo"]["estado_recuperacion_precosecha"], "sin_recuperacion")
        self.assertTrue(reporte["recuperacion_precosecha"]["tiene_precosecha"])
        self.assertEqual(reporte["recuperacion_precosecha"]["total_invertido"], 120.0)
        self.assertEqual(reporte["recuperacion_precosecha"]["recuperado"], 0.0)
        self.assertEqual(reporte["recuperacion_precosecha"]["pendiente"], 120.0)
        self.assertEqual(reporte["recuperacion_precosecha"]["porcentaje"], 0.0)
        self.assertEqual(reporte["recuperacion_precosecha"]["estado"], "sin_recuperacion")
